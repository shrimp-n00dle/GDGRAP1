...
/*
* Todays lesson: shaders
* ADDING DATA OUTSIDE OF ATTRIB POINTER
* IMPLEMENATION OF SHADERS AND FRAGMENTS
* SIMPLE INPUT
*/

//Global scope
//Modifier for models x position
float x_mod = 0;
float y_mod = 0;

void Key_Callback(GLFWwindow* window, //pointer to window
    int key,//keycode of the presses
    int scancode, //physical poitions of the press
    int action,// either press/release
    int mods) // which of the modifer keys is held down
...
int main(void)
{
    ...
    window = glfwCreateWindow(640, 640, "Jan Elizabeth Vingno", NULL, NULL);
    if (!window)
    {
        glfwTerminate();
        return -1;
    ...
    */
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        /*
        //Get address of variablex in the shader
